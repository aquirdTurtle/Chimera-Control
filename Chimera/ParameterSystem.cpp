	...
	switch (subitem)
	{
		...
		case 1:
		{
			if ( paramSysType == ParameterSysType::global )
			{
				...
				{
					throwNested ( "ERROR: the value entered, " + newValue + ", failed to convert to a double! "
		...
		default:
		{
			...
			else if((subitem - preRangeColumns) % 3 == 2)
			{
				...
				{
					throwNested ("ERROR: the value entered, " + newValue + ", failed to convert to a double! Check "
