...
#define UWAVE_AGILENT_TRIGGER_ROW 0
#define UWAVE_AGILENT_TRIGGER_NUM 0
#define TOP_BOTTOM_AGILENT_TRIGGER_ROW 0
#define TOP_BOTTOM_AGILENT_TRIGGER_NUM 0
#define AXIAL_AGILENT_TRIGGER_ROW 0
#define AXIAL_AGILENT_TRIGGER_NUM 0
#define FLASHING_AGILENT_TRIGGER_ROW 0
#define FLASHING_AGILENT_TRIGGER_NUM 0
#define INTENSITY_AGILENT_TRIGGER_ROW 0
#define INTENSITY_AGILENT_TRIGGER_NUM 0
