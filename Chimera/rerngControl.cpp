...
rerngOptionsForm rerngControl::getParams( )
{
	rerngOptionsForm tempParams;
...
void rerngControl::handleSaveConfig( std::ofstream& saveFile )
{
	...
	rerngOptionsForm info = getParams( );
...
void rerngControl::setParams( rerngOptionsForm params )
{
