...
const DWORD NORM_COMBO_OPTIONS = NORM_CWND_OPTIONS | CBS_DROPDOWNLIST | CBS_HASSTRINGS | WS_TABSTOP;// | WS_OVERLAPPED;
...
void Control<ControlType>::rearrange( AndorRunModes::mode cameraMode, AndorTriggerMode::mode trigMode, int width, int height, fontMap fonts)
{
	...
	double widthScale = width / 3840.0;
	double heightScale = height / 2160.0;
	double resolutionModifier = 1/9.0;
	/// Set Fonts
