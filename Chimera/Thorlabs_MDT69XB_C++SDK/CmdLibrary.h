...
/// <param name="length">the length of the serialNo buffer</param>
/// <returns>non-negative number: number of device in the list; negative number: failed.</returns>
COMMANDLIB_API int List(unsigned char *serialNo, unsigned int length);
...
/// <returns>
/// <p>0: Success; negative number: failed.</p>ossible port on this computer. 
/// </returns>
