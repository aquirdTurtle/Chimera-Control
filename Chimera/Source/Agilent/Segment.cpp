...
//		input.ramp.start.internalEvaluate (variables, variation);
//		input.ramp.end.internalEvaluate (variables, variation);
//		//finalSettings.ramp.start = input.ramp.start.internalEvaluate( variables, variation );
...
//		/*finalSettings.pulse.vOffset = */input.pulse.vOffset.internalEvaluate ( variables, variation );
//		/*finalSettings.pulse.amplitude = */input.pulse.amplitude.internalEvaluate ( variables, variation );
//		/*finalSettings.pulse.tOffset = */input.pulse.tOffset.internalEvaluate ( variables, variation ) / 1000.0;
//		/*finalSettings.pulse.width = */input.pulse.width.internalEvaluate ( variables, variation ) / 1000.0;
//	}
//	else{
//		/*finalSettings.holdVal = */input.holdVal.internalEvaluate ( variables, variation );
//	}
//
//	if ( input.mod.modulationIsOn )	{
//		/*finalSettings.mod.frequency = */input.mod.frequency.internalEvaluate ( variables, variation );
//		/*finalSettings.mod.phase = */input.mod.phase.internalEvaluate ( variables, variation );
//	}
