...
class PlotDesignerDialog : public CDialog
{
	...
	public:
		PlotDesignerDialog( fontMap* fonts, unsigned pictureNumber ) : CDialog( IDD_LARGE_TEMPLATE ), 
	...
	private:
		...
		Control<CComboBox> dataSetNumCombo;
		...
		Control<CComboBox> prcPicNumCombo;
		Control<CStatic> prcPixelNumberText;
		Control<CComboBox> prcPixelNumCombo;
		...
		Control<CComboBox> pscConditionNumCombo;
		Control<CStatic> pscPictureNumberText;
		Control<CComboBox> pscPicNumCombo;
		Control<CStatic> pscPixelNumberText;
		Control<CComboBox> pscPixelNumCombo;
		...
		Control<CStatic> binWidthText;
		Control<CEdit> binWidthEdit;
