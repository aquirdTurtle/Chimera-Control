...
const std::vector<autoCalConfigInfo> AUTO_CAL_LIST {
	...
	{
		/*prof*/ {"GPulse_Thermal_Top_Sideband_Raman_Spectroscopy", "Atoms", PROFILES_PATH + "Hotkey Experiments\\Atoms"},
		/*filename*/ "THERMAL_TOP_SIDEBAND_RAMAN_SPECTROSCOPY",
		/*infostr*/ "Running Thermal Top Raman Sideband Spectroscopy...\r\n"
	},
	{
		/*prof*/ { "3DGSBC_Carrier_Calibration", "Atoms", PROFILES_PATH + "Hotkey Experiments\\Atoms" },
		/*filename*/ "3DSBC_TOP_CARRIER_RAMAN_SPECTROSCOPY",
		/*infostr*/ "Running 3DSBC Top Carrier Raman Spectroscopy...\r\n"
	},
	{
		/*prof*/ { "3DGSBC_Axial_Sideband_Spectroscopy", "Atoms", PROFILES_PATH + "Hotkey Experiments\\Atoms" },
		/*filename*/ "3DSBC_AXIAL_RAMAN_SPECTROSCOPY",
		/*infostr*/ "Running 3DSBC Axial Raman Spectroscopy...\r\n"
	},
	{
		/*prof*/ { "3DGSBC_Top_Sideband_Spectroscopy", "Atoms", PROFILES_PATH + "Hotkey Experiments\\Atoms" },
	...
	{		
		/*prof*/ { "Lifetime_Measurement", "Atoms", PROFILES_PATH + "Hotkey Experiments\\Atoms" },
