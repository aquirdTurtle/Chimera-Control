...
QT_MOC_LITERAL(2, 29, 0) // ""
    ...
    "ParameterModel\0editCompleted\0"
};
...
void ParameterModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ParameterModel *_t = static_cast<ParameterModel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (ParameterModel::*_t)(const QString & );
...
const QMetaObject ParameterModel::staticMetaObject = {
    { &QAbstractTableModel::staticMetaObject, qt_meta_stringdata_ParameterModel.data,
      qt_meta_data_ParameterModel,  qt_static_metacall, nullptr, nullptr}
};
