...
void QtAuxiliaryWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QtAuxiliaryWindow *_t = static_cast<QtAuxiliaryWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject QtAuxiliaryWindow::staticMetaObject = {
    { &IChimeraWindowWidget::staticMetaObject, qt_meta_stringdata_QtAuxiliaryWindow.data,
      qt_meta_data_QtAuxiliaryWindow,  qt_static_metacall, nullptr, nullptr}
};
