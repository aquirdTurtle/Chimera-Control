...
void CruncherThreadWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CruncherThreadWorker *_t = static_cast<CruncherThreadWorker *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (CruncherThreadWorker::*_t)(QString );
        ...
        {
            typedef void (CruncherThreadWorker::*_t)(atomQueue );
        ...
        {
            typedef void (CruncherThreadWorker::*_t)(PixListQueue );
...
const QMetaObject CruncherThreadWorker::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CruncherThreadWorker.data,
      qt_meta_data_CruncherThreadWorker,  qt_static_metacall, nullptr, nullptr}
};
