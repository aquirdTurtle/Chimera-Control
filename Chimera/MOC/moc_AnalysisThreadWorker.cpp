...
void AnalysisThreadWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        AnalysisThreadWorker *_t = static_cast<AnalysisThreadWorker *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (AnalysisThreadWorker::*_t)(std::vector<std::vector<dataPoint>> , int );
...
const QMetaObject AnalysisThreadWorker::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_AnalysisThreadWorker.data,
      qt_meta_data_AnalysisThreadWorker,  qt_static_metacall, nullptr, nullptr}
};
