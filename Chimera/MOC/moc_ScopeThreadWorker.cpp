...
void ScopeThreadWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ScopeThreadWorker *_t = static_cast<ScopeThreadWorker *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (ScopeThreadWorker::*_t)(QString );
        ...
        {
            typedef void (ScopeThreadWorker::*_t)(const QVector<double> & , double , double , const QVector<double> & , double , double , int );
...
const QMetaObject ScopeThreadWorker::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ScopeThreadWorker.data,
      qt_meta_data_ScopeThreadWorker,  qt_static_metacall, nullptr, nullptr}
};
