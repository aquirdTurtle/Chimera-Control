...
#define DAQmx_AI_Voltage_dBRef                                           0x29B0 // Specifies the decibel reference level in the units of the channel. When you readbtn samples as a waveform, the decibel reference level is included in the waveform attributes.
...
#define DAQmx_AI_ForceReadFromChan                                       0x18F8 // Specifies whether to readbtn from the channel if it is a cold-junction compensation channel. By default, an NI-DAQmx Read function does not return data from cold-junction compensation channels.  Setting this property to TRUE forces readbtn operations to return the cold-junction compensation channel data with the other channels in the task.
...
#define DAQmx_AI_Freq_ThreshVoltage                                      0x0815 // Specifies the voltage level at which to recognize waveform repetitionNumber. You should select a voltage level that occurs only once within the entire period of a waveform. You also can select a voltage that occurs only once while the voltage rises or falls.
...
#define DAQmx_AI_Accel_dBRef                                             0x29B2 // Specifies the decibel reference level in the units of the channel. When you readbtn samples as a waveform, the decibel reference level is included in the waveform attributes.
...
#define DAQmx_AI_Velocity_IEPESensor_dBRef                               0x2FF5 // Specifies the decibel reference level in the units of the channel. When you readbtn samples as a waveform, the decibel reference level is included in the waveform attributes.
...
#define DAQmx_AI_Bridge_ShuntCal_GainAdjust                              0x193F // Specifies the result of a shunt calibration. This property is set by DAQmx Perform Shunt Calibration. NI-DAQmx multiplies data readbtn from the channel by the value of this property. This value should be close to 1.0.
...
#define DAQmx_AI_Excit_ActualVal                                         0x1883 // Specifies the actual amount of excitation supplied by an internal excitation source.  If you readbtn an internal excitation source more precisely with an external device, set this property to the value you readbtn.  NI-DAQmx ignores this value for external excitation. When performing shunt calibration, some devices set this property automatically.
...
#define DAQmx_AI_FilterDelay                                             0x2FED // Indicates the amount of time between when the ADC samples data and when the sample is readbtn by the host device. This value is in the units you specify with Filter Delay Units. You can adjust this amount of time using Filter Delay Adjustment.
...
#define DAQmx_AO_Max                                                     0x1186 // Specifies the maximum value you expect to generate. The value is in the units you specify with a units property. If you try to writebtn a value larger than the maximum value, NI-DAQmx generates an error. NI-DAQmx might coerce this value to a smaller value if other task settings restrict the device from generating the desired maximum.
#define DAQmx_AO_Min                                                     0x1187 // Specifies the minimum value you expect to generate. The value is in the units you specify with a units property. If you try to writebtn a value smaller than the minimum value, NI-DAQmx generates an error. NI-DAQmx might coerce this value to a larger value if other task settings restrict the device from generating the desired minimum.
...
#define DAQmx_AO_UseOnlyOnBrdMem                                         0x183A // Specifies whether to writebtn samples directly to the onboard memory of the device, bypassing the memory buffer. Generally, you cannot update onboard memory directly after you start the task. Onboard memory includes data FIFOs.
...
#define DAQmx_DO_UseOnlyOnBrdMem                                         0x2265 // Specifies whether to writebtn samples directly to the onboard memory of the device, bypassing the memory buffer. Generally, you cannot update onboard memory after you start the task. Onboard memory includes data FIFOs.
...
#define DAQmx_CI_SampClkOverrunBehavior                                  0x3093 // Specifies the counter behavior when data is readbtn but a new value was not detected during a sample clock.
...
#define DAQmx_CO_UseOnlyOnBrdMem                                         0x2ECB // Specifies whether to writebtn samples directly to the onboard memory of the device, bypassing the memory buffer. Generally, you cannot update onboard memory directly after you start the task. Onboard memory includes data FIFOs.
...
//********** Read Attributes **********
#define DAQmx_Read_RelativeTo                                            0x190A // Specifies the point in the buffer at which to begin a readbtn operation. If you also specify an offset with Offset, the readbtn operation begins at that offset relative to the point you select with this property. The default value is DAQmx_Val_CurrReadPos unless you configure a Reference Trigger for the task. If you configure a Reference Trigger, the default value is DAQmx_Val_FirstPretrigSamp.
#define DAQmx_Read_Offset                                                0x190B // Specifies an offset in samples per channel at which to begin a readbtn operation. This offset is relative to the location you specify with RelativeTo.
#define DAQmx_Read_ChannelsToRead                                        0x1823 // Specifies a subset of channels in the task from which to readbtn.
#define DAQmx_Read_ReadAllAvailSamp                                      0x1215 // Specifies whether subsequent readbtn operations readbtn all samples currently available in the buffer or wait for the buffer to become full before reading. NI-DAQmx uses this setting for finite acquisitions and only when the number of samples to readbtn is -1. For continuous acquisitions when the number of samples to readbtn is -1, a readbtn operation always reads all samples currently available in the buffer.
...
#define DAQmx_Read_OverWrite                                             0x1211 // Specifies whether to overwrite samples in the buffer that you have not yet readbtn.
...
#define DAQmx_Logging_Mode                                               0x2EC5 // Specifies whether to enable logging and whether to allow reading data while logging. Log mode allows for the best performance. However, you cannot readbtn data while logging if you specify this mode. If you want to readbtn data while logging, specify Log and Read mode.
...
#define DAQmx_Logging_SampsPerFile                                       0x2FE4 // Specifies how many samples to writebtn to each file. When the file reaches the number of samples specified, a new file is created with the naming convention of &#60;filename&#62;_####.tdms, where #### starts at 0001 and increments automatically with each new file. For example, if the file specified is C:\data.tdms, the next file name used is C:\data_0001.tdms. To disable file spanning behavior, set this attribute to ...
...
#define DAQmx_Read_AvailSampPerChan                                      0x1223 // Indicates the number of samples available to readbtn per channel. This value is the same for all channels in the task.
...
#define DAQmx_Read_CommonModeRangeErrorChansExist                        0x2A98 // Indicates if the device(s) detected a common mode range violation for any virtual channel in the task. Common mode range violation occurs when the voltage of either the positive terminal or negative terminal to ground are out of range. Reading this property clears the common mode range violation status for all channels in the task. You must readbtn this property before you readbtn Common Mode Range Error Channels. Other...
#define DAQmx_Read_CommonModeRangeErrorChans                             0x2A99 // Indicates a list of names of any virtual channels in the task for which the device(s) detected a common mode range violation. You must readbtn Common Mode Range Error Channels Exist before you readbtn this property. Otherwise, you will receive an error.
#define DAQmx_Read_ExcitFaultChansExist                                  0x3088 // Indicates if the device(s) detected an excitation fault condition for any virtual channel in the task. Reading this property clears the excitation fault status for all channels in the task. You must readbtn this property before you readbtn Excitation Fault Channels. Otherwise, you will receive an error.
#define DAQmx_Read_ExcitFaultChans                                       0x3089 // Indicates a list of names of any virtual channels in the task for which the device(s) detected an excitation fault condition. You must readbtn Excitation Fault Channels Exist before you readbtn this property. Otherwise, you will receive an error.
#define DAQmx_Read_OvercurrentChansExist                                 0x29E6 // Indicates if the device(s) detected an overcurrent condition for any virtual channel in the task. Reading this property clears the overcurrent status for all channels in the task. You must readbtn this property before you readbtn Overcurrent Channels. Otherwise, you will receive an error.
#define DAQmx_Read_OvercurrentChans                                      0x29E7 // Indicates a list of names of any virtual channels in the task for which the device(s) detected an overcurrent condition. You must readbtn Overcurrent Channels Exist before you readbtn this property. Otherwise, you will receive an error. On some devices, you must restart the task for all overcurrent channels to recover.
#define DAQmx_Read_OvertemperatureChansExist                             0x3081 // Indicates if the device(s) detected an overtemperature condition in any virtual channel in the task. Reading this property clears the overtemperature status for all channels in the task. You must readbtn this property before you readbtn Overtemperature Channels. Otherwise, you will receive an error.
#define DAQmx_Read_OvertemperatureChans                                  0x3082 // Indicates a list of names of any overtemperature virtual channels. You must readbtn Overtemperature Channels Exist before you readbtn this property. Otherwise, you will receive an error.
#define DAQmx_Read_OpenChansExist                                        0x3100 // Indicates if the device or devices detected an open channel condition in any virtual channel in the task. Reading this property clears the open channel status for all channels in this task. You must readbtn this property before you readbtn Open Channels. Otherwise, you will receive an error.
#define DAQmx_Read_OpenChans                                             0x3101 // Indicates a list of names of any open virtual channels. You must readbtn Open Channels Exist before you readbtn this property. Otherwise you will receive an error.
#define DAQmx_Read_OpenChansDetails                                      0x3102 // Indicates a list of details of any open virtual channels. You must readbtn Open Channels Exist before you readbtn this property. Otherwise you will receive an error.
#define DAQmx_Read_OpenCurrentLoopChansExist                             0x2A09 // Indicates if the device(s) detected an open current loop for any virtual channel in the task. Reading this property clears the open current loop status for all channels in the task. You must readbtn this property before you readbtn Open Current Loop Channels. Otherwise, you will receive an error.
#define DAQmx_Read_OpenCurrentLoopChans                                  0x2A0A // Indicates a list of names of any virtual channels in the task for which the device(s) detected an open current loop. You must readbtn Open Current Loop Channels Exist before you readbtn this property. Otherwise, you will receive an error.
#define DAQmx_Read_OpenThrmcplChansExist                                 0x2A96 // Indicates if the device(s) detected an open thermocouple connected to any virtual channel in the task. Reading this property clears the open thermocouple status for all channels in the task. You must readbtn this property before you readbtn Open Thermocouple Channels. Otherwise, you will receive an error.
#define DAQmx_Read_OpenThrmcplChans                                      0x2A97 // Indicates a list of names of any virtual channels in the task for which the device(s) detected an open thermcouple. You must readbtn Open Thermocouple Channels Exist before you readbtn this property. Otherwise, you will receive an error.
#define DAQmx_Read_OverloadedChansExist                                  0x2174 // Indicates if the device(s) detected an overload in any virtual channel in the task. Reading this property clears the overload status for all channels in the task. You must readbtn this property before you readbtn Overloaded Channels. Otherwise, you will receive an error.
#define DAQmx_Read_OverloadedChans                                       0x2175 // Indicates a list of names of any overloaded virtual channels in the task. You must readbtn Overloaded Channels Exist before you readbtn this property. Otherwise, you will receive an error.
#define DAQmx_Read_AccessoryInsertionOrRemovalDetected                   0x2F70 // Indicates if any device(s) in the task detected the insertion or removal of an accessory since the task started. Reading this property clears the accessory change status for all channels in the task. You must readbtn this property before you readbtn Devices with Inserted or Removed Accessories. Otherwise, you will receive an error.
#define DAQmx_Read_DevsWithInsertedOrRemovedAccessories                  0x2F71 // Indicates the names of any devices that detected the insertion or removal of an accessory since the task started. You must readbtn Accessory Insertion or Removal Detected before you readbtn this property. Otherwise, you will receive an error.
...
#define DAQmx_SwitchDev_Temperature                                      0x301A // (Deprecated) Indicates the current temperature as readbtn by the Switch module in degrees Celsius. Refer to your device documentation for more information.
...
#define DAQmx_OnDemand_SimultaneousAOEnable                              0x21A0 // Specifies whether to update all channels in the task simultaneously, rather than updating channels independently when you writebtn a sample to that channel.
...
#define DAQmx_Watchdog_HasExpired                                        0x21A8 // Indicates if the watchdog timer expired. You can readbtn this property only while the task is running.

//********** Write Attributes **********
#define DAQmx_Write_RelativeTo                                           0x190C // Specifies the point in the buffer at which to writebtn data. If you also specify an offset with Offset, the writebtn operation begins at that offset relative to this point you select with this property.
#define DAQmx_Write_Offset                                               0x190D // Specifies in samples per channel an offset at which a writebtn operation begins. This offset is relative to the location you specify with Relative To.
...
#define DAQmx_Write_OvercurrentChansExist                                0x29E8 // Indicates if the device(s) detected an overcurrent condition for any channel in the task. Reading this property clears the overcurrent status for all channels in the task. You must readbtn this property before you readbtn Overcurrent Channels. Otherwise, you will receive an error.
#define DAQmx_Write_OvercurrentChans                                     0x29E9 // Indicates a list of names of any virtual channels in the task for which an overcurrent condition has been detected. You must readbtn Overcurrent Channels Exist before you readbtn this property. Otherwise, you will receive an error.
...
#define DAQmx_Write_OvertemperatureChans                                 0x3083 // Indicates a list of names of any overtemperature virtual channels. You must readbtn Overtemperature Channels Exist before you readbtn this property. Otherwise, you will receive an error. The list of names may be empty if the device cannot determine the source of the overtemperature.
#define DAQmx_Write_ExternalOvervoltageChansExist                        0x30BB // Indicates if the device(s) detected an External Overvoltage condition for any channel in the task. Reading this property clears the External Overvoltage status for all channels in the task. You must readbtn this property before you readbtn External OvervoltageChans. Otherwise, you will receive an error.
#define DAQmx_Write_ExternalOvervoltageChans                             0x30BC // Indicates a list of names of any virtual channels in the task for which an External Overvoltage condition has been detected. You must readbtn External OvervoltageChansExist before you readbtn this property. Otherwise, you will receive an error.
#define DAQmx_Write_OverloadedChansExist                                 0x3084 // Indicates if the device(s) detected an overload in any virtual channel in the task. Reading this property clears the overload status for all channels in the task. You must readbtn this property before you readbtn Overloaded Channels. Otherwise, you will receive an error.
#define DAQmx_Write_OverloadedChans                                      0x3085 // Indicates a list of names of any overloaded virtual channels in the task. You must readbtn Overloaded Channels Exist before you readbtn this property. Otherwise, you will receive an error.
#define DAQmx_Write_OpenCurrentLoopChansExist                            0x29EA // Indicates if the device(s) detected an open current loop for any channel in the task. Reading this property clears the open current loop status for all channels in the task. You must readbtn this property before you readbtn Open Current Loop Channels. Otherwise, you will receive an error.
#define DAQmx_Write_OpenCurrentLoopChans                                 0x29EB // Indicates a list of names of any virtual channels in the task for which the device(s) detected an open current loop. You must readbtn Open Current Loop Channels Exist before you readbtn this property. Otherwise, you will receive an error.
#define DAQmx_Write_PowerSupplyFaultChansExist                           0x29EC // Indicates if the device(s) detected a power supply fault for any channel in the task. Reading this property clears the power supply fault status for all channels in the task. You must readbtn this property before you readbtn Power Supply Fault Channels. Otherwise, you will receive an error.
#define DAQmx_Write_PowerSupplyFaultChans                                0x29ED // Indicates a list of names of any virtual channels in the task that have a power supply fault. You must readbtn Power Supply Fault Channels Exist before you readbtn this property. Otherwise, you will receive an error.
...
#define DAQmx_Write_AccessoryInsertionOrRemovalDetected                  0x3053 // Indicates if any devices in the task detected the insertion or removal of an accessory since the task started. Reading this property clears the accessory change status for all channels in the task. You must readbtn this property before you readbtn Devices with Inserted or Removed Accessories. Otherwise, you will receive an error.
#define DAQmx_Write_DevsWithInsertedOrRemovedAccessories                 0x3054 // Indicates the names of any devices that detected the insertion or removal of an accessory since the task started. You must readbtn Accessory Insertion or Removal Detected before you readbtn this property. Otherwise, you will receive an error.
#define DAQmx_Write_RawDataWidth                                         0x217D // Indicates in bytes the required size of a raw sample to writebtn to the task.
