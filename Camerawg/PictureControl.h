...
class PictureControl
{
	public:
		...
		void drawCircle(CWnd* parent, POINT selectedLocation );
		...
		POINT checkClickLocation();
	private:
		// for replotting.
		std::vector<long> mostRecentImage;
		// stores info as to whether the control is currently being used in plotting camera data or was used in the most recent run.
		bool active;
		//
