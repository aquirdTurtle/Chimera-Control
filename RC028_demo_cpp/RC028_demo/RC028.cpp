...
int RC028::run_cont(bool onoff)
{
	...
	else if (this->connType == ASYNC)
	{
		...
		dataBuffer[0] = 161; //dev
		dataBuffer[1] = 0; //address hi
		dataBuffer[2] = 1; //address lo
		dataBuffer[3] = 0; //data msb
		dataBuffer[4] = 0;
		dataBuffer[5] = 0;
		dataBuffer[6] = 0; //data lsb
		if (onoff == true)dataBuffer[6] = 1;
