...
void createIdentityPalette(HDC& ScreenDC)
{
	...
	eAppPalette[0] = CreatePalette((LOGPALETTE *)&Palette);
	SelectPalette(ScreenDC, eAppPalette[0], TRUE);
	...
	eAppPalette[1] = CreatePalette((LOGPALETTE *)&Palette);
	SelectPalette(ScreenDC, eAppPalette[1], TRUE);
	RealizePalette(ScreenDC);
	///
	...
	eAppPalette[2] = CreatePalette((LOGPALETTE *)&Palette);
	SelectPalette(ScreenDC, eAppPalette[2], TRUE);
	RealizePalette(ScreenDC);
}
